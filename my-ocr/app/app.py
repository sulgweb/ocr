...
LastEditTime: 2022-06-08 01:03:42
'''
...
def distinguish_img(img_path):
    ...
    ocr = PaddleOCR(use_angle_cls=True, lang="ch",enable_mkldnn=False, use_gpu=False, use_tensorrt= True)  # need to run only once to download and load model into memory
